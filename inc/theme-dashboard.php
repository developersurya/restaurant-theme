...
function finedine_admin_notice() {
	...
	<div class="updated notice notice-success notice-alt is-dismissible">
		<p><?php printf( __( 'Thank you for downloading Finedine. Please visit our <strong><a href="%2$s">Welcome Page</a></strong>  for how-tos and documentation.', 'finedine' ), esc_html( $theme_data->Name ), esc_url( admin_url( 'themes.php?page=sm_finedine' ) ) ); ?></p>
	</div>
	<?php
}
...
function finedine_admin_import_notice() {
	...
	<div class="updated notice notice-success notice-alt is-dismissible">
		...
		<p><?php printf( 'To make your transition faster, you can import our <strong><a href="' . esc_url ( admin_url( 'themes.php' ) ) . '?page=sm_finedine&tab=demo-data-importer">Demo Content</a></strong>.', 'finedine' ); ?></p>
	</div>
	<?php
}
...
function finedine_theme_info_page() {
	...
	<div class="wrap about-wrap theme-detail-wrapper">
		...
		<p><a href="<?php echo esc_url( 'https://www.sampression.com/themes/finedine/' ); ?>" class="button" target="_blank"><?php esc_html_e( 'Theme Info', 'finedine' ) ?></a>&nbsp;&nbsp;<a href="<?php echo esc_url( 'https://www.sampression.com/support/' ); ?>" class="button" target="_blank"><?php esc_html_e( 'Support', 'finedine' ) ?></a>&nbsp;&nbsp;<a href="<?php echo esc_url( 'https://www.sampression.com/documentation-finedine/' ); ?>" class="button" target="_blank"><?php esc_html_e( 'Documentation', 'finedine' ) ?></a>&nbsp;&nbsp;<a href="<?php echo esc_url( 'https://www.demo.sampression.com/finedine/' ); ?>" class="button" target="_blank"><?php esc_html_e( 'Live Theme Demo', 'finedine' ) ?></a>&nbsp;&nbsp;<a href="<?php echo esc_url( 'https://www.sampression.com/forums/' ); ?>" class="button" target="_blank"><?php esc_html_e( 'Community Forum', 'finedine' ) ?></a>&nbsp;&nbsp;<a href="#" class="button button-primary" target="_blank">Upgrade To Pro Theme</a>&nbsp;&nbsp;</p>
		...
		<?php if ( $sm_theme_tab == 'demo-data-importer' ) { ?>
			<div class="demo-import-box info-tab-content">
				<?php
				echo wp_kses( __( 'Install <a href="/wp-admin/plugin-install.php?tab=plugin-information&plugin=one-click-demo-import"  target="_blank">One Click Demo Import</a>
plugin to import demo content. Demo data are bundled within the theme, Please make sure plugin is installed and activated. After plugin activation,
